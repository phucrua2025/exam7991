...
- VD (Vận dụng): Áp dụng vào tình huống thực tế hoặc tổng hợp kiến thức.`;
...
export const suggestTopicPlan = async (
  ...
  Phân bổ mức độ (NB, TH, VD) hợp lý để phân loại học sinh.`;
  ...
  try {
    ...
    return [
      ...
      { id: '7', topic: genericTopic(7), type: 'SA', count: 3, level: 'VD' },
    ];
  }
};
